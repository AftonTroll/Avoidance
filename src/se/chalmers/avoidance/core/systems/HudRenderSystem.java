...
public class HudRenderSystem extends EntityProcessingSystem {
	 ...
	 * @param font
	 *            The font of the score text
	 */
	public HudRenderSystem(Scene scene, VertexBufferObjectManager vbom,
			Font font) {
	...
	protected void initialize() {
		...
		timeText = new Text(30, 30, this.font, "Time :",
				"Time: XXXXX".length(), vbom);
	...
	protected void process(Entity entity) {
		...
		scoreText.setText("Score :"
				+ (Math.round(time.getTime()) * 10 + score.getScore()));
	}

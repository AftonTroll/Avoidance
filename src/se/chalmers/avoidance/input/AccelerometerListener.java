...
/**
 * A listener that listens to the sensor and passes on the values to its
 * listeners.
 * 
...
public class AccelerometerListener implements SensorEventListener {
	...
	/**
	 * Constructs a new listener for the accelerometer from the given
	 * sensorManager.
	 * 
	 * @param sensorManager
	...
	public void onSensorChanged(SensorEvent event) {
		...
		pcs.firePropertyChange("AccelerometerY", null, event.values[0]);
	}

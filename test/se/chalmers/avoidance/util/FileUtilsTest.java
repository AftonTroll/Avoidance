...
public class FileUtilsTest {
	...
	/**
	 * Helper-method for telling if a list of <code>Integer</code> is sorted
	 * from highest to lowest.
	 * 
	 * @param list
	 *            the list to check
	 * @throws AssertionError
	 *             if it is not sorted from highest to lowest
	 */
	...
	public void testCreateMultiLineStringListOfStringInt() {
		// null reference
		assertTrue("".equalsIgnoreCase(FileUtils
				.createMultiLineString(null, M1)));

		// no line
		List<String> list = new ArrayList<String>();
		assertTrue("".equalsIgnoreCase(FileUtils
				.createMultiLineString(list, M1)));

		// 1 line
		list.add(W1);
		assertTrue(W1.equalsIgnoreCase(FileUtils
				.createMultiLineString(list, M1)));
